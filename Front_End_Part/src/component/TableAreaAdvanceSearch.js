                  ...
                  .map((row, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <Button 
                        onClick={()=>setModal({open:true,movie_name:row.movieName,theatre_name:row.theatreName,movieValidityStart:row.movieValidityStart,movieValidityEnds:row.movieValidityEnds})}
                        sx={{
                          color: "white",
                          px: 4,
                          border:1,
