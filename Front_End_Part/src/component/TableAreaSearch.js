...
const MyTableBody=({ userData,setSelectedData, searchingId, searchIdCount,setRefresh })=> {
        ...
        <Paper sx={{ width: "100%", mb: 2 }}>
          ...
          />
      ...
      </Box>
                {
                  ...
                  movieValidityStart={modal.movieValidityStart} movieValidityEnds={modal.movieValidityEnds}   close={() => setModal({open:false,movie_name:"",theatre_name:""})} setRefresh={setRefresh}/>
                  )
                }
      </>
    );
...
export default TableAreaSearch;
